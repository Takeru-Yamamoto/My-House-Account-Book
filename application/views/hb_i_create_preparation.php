            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="card card-primary">
                        <!-- form start -->
                        <form role="form" action="<?php echo base_url(); ?>hb_i/create" method="POST" accept-charset="utf-8">
                            <div class="card-body">
                                <p>
                                ...
                                <div class="form-group">
                                    <label>収入金額</label>
                                    <input type="number" name="amount" class="form-control" placeholder="収入金額を入力してください">
                                </div>
                                <div class="form-group">
                                    <label>コメント</label>
